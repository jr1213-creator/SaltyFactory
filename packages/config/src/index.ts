...
const envSchema = z.object({
  ...
  AI_EMPLOYEES_REAL_AGENT_ENABLED: asBool(false),
  AI_EMPLOYEES_MODEL_PROVIDER: z.enum(["ollama"]).default("ollama"),
  AI_EMPLOYEES_AGENT_EXECUTION_MODE: z.enum(["queued", "inline_test"]).default("queued"),
  AI_EMPLOYEES_AGENT_MAX_CONCURRENCY: z.string().optional().default("1"),
  AI_EMPLOYEES_AGENT_MAX_RUNS_PER_WORKSPACE_PER_DAY: z.string().optional().default("25"),
  OLLAMA_BASE_URL: z.string().optional().default("http://127.0.0.1:11434"),
  OLLAMA_MODEL: z.string().optional().default("qwen3:8b"),
  OLLAMA_AGENT_MAX_TURNS: z.string().optional().default("6"),
  OLLAMA_AGENT_TIMEOUT_MS: z.string().optional().default("120000"),
  OLLAMA_AGENT_KEEP_ALIVE: z.string().optional().default("5m"),
  OLLAMA_AGENT_THINK: asBool(false),
  ...
  CUSTOMER_CONCIERGE_ENABLED: asBool(false),
  CUSTOMER_CONCIERGE_AUTO_PUBLISH_ENABLED: asBool(false),
  CUSTOMER_CONCIERGE_ALLOW_SHOPIFY_PRODUCT_CREATE: asBool(false),
  CUSTOMER_CONCIERGE_ALLOW_PUBLIC_COLLECTION_PROMOTION: asBool(false),
  CUSTOMER_CONCIERGE_MAX_CANDIDATES: z.string().optional().default("5"),
  CUSTOMER_CONCIERGE_MAX_MESSAGES_PER_SESSION: z.string().optional().default("20"),
  CUSTOMER_CONCIERGE_MAX_GENERATIONS_PER_SESSION: z.string().optional().default("3"),
  CUSTOMER_CONCIERGE_MAX_PUBLISH_REQUESTS_PER_SESSION: z.string().optional().default("3"),
  CUSTOMER_CONCIERGE_SESSION_TTL_HOURS: z.string().optional().default("24"),
  CUSTOMER_CONCIERGE_ALLOWED_PRODUCT_TYPES: z.string().optional().default("shirt,tee,t-shirt,hoodie,tank,hat,tote,sticker,keychain"),
  CUSTOMER_CONCIERGE_DEFAULT_PRODUCT_TYPE: z.string().optional().default("shirt"),
  CUSTOMER_CONCIERGE_REQUIRE_POLICY_PASS: asBool(true),
  CUSTOMER_CONCIERGE_REQUIRE_MARGIN_PASS: asBool(true),
  CUSTOMER_CONCIERGE_REQUIRE_PREVIEW_QA_PASS: asBool(true),
  CUSTOMER_CONCIERGE_SHOPIFY_PRODUCT_CREATE_MODE: z.enum(["disabled", "test_adapter", "live"]).default("disabled"),
  RUN_LIVE_CUSTOMER_CONCIERGE_SHOPIFY_SMOKE: asBool(false),
  RUN_LIVE_CUSTOMER_CONCIERGE_IMAGE_SMOKE: asBool(false),
  ...
  ETSY_CLIENT_ID: z.string().optional().default(""),
  ...
  PINTEREST_TRENDS_ENABLED: asBool(false),
  PINTEREST_TRENDS_APPROVED: asBool(false),
  PINTEREST_ACCESS_TOKEN: z.string().optional().default(""),
  PINTEREST_TRENDS_API_BASE_URL: z.string().optional().default("https://api.pinterest.com/v5"),
  GOOGLE_TRENDS_ALPHA_ENABLED: asBool(false),
  GOOGLE_TRENDS_ALPHA_APPROVED: asBool(false),
  GOOGLE_TRENDS_ALPHA_API_KEY: z.string().optional().default(""),
  GOOGLE_TRENDS_ALPHA_ACCESS_TOKEN: z.string().optional().default(""),
  GOOGLE_TRENDS_ALPHA_BASE_URL: z.string().optional().default("https://trends.googleapis.com"),
  META_AD_LIBRARY_ENABLED: asBool(false),
  META_AD_LIBRARY_APPROVED: asBool(false),
  META_AD_LIBRARY_ACCESS_TOKEN: z.string().optional().default(""),
  REDDIT_API_ENABLED: asBool(false),
  REDDIT_COMMERCIAL_APPROVED: asBool(false),
  ...
  REDDIT_ACCESS_TOKEN: z.string().optional().default(""),
  TIKTOK_COMMERCIAL_API_ENABLED: asBool(false),
  TIKTOK_APPROVED_ACCESS: asBool(false),
  TIKTOK_ACCESS_TOKEN: z.string().optional().default(""),
  TIKTOK_API_BASE_URL: z.string().optional().default("https://open.tiktokapis.com"),
  LICENSED_TREND_PROVIDER_ENABLED: asBool(false),
  LICENSED_TREND_PROVIDER_APPROVED: asBool(false),
  LICENSED_TREND_PROVIDER_NAME: z.string().optional().default(""),
  LICENSED_TREND_PROVIDER_API_KEY: z.string().optional().default(""),
  LICENSED_TREND_PROVIDER_BASE_URL: z.string().optional().default(""),
