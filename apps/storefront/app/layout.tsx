...
export default function Layout({ children }: { children: React.ReactNode }) {
  return <html lang="en"><body>
    ...
    <nav className="store-nav" aria-label="Storefront navigation">
      ...
      <div className="store-links"><a href="/store">Store</a><a href="/store/custom">Custom</a><a href="/collections">Collections</a><a href="/drops">Drops</a><a href="/about">About</a><a href="/size-guide">Size Guide</a><a href="/faq">FAQ</a></div>
