...
export default async function ListingDraftsPage() {
  ...
  return <>
    ...
    <section className="card" style={{ marginTop: 18 }}>
      ...
      <form className="layout-grid layout-grid-3" action="/api/studio/listing-drafts" method="post">
