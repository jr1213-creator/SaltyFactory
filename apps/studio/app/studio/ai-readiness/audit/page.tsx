...
export default function Page() {
  return <>
    ...
    <section className="surface-card">
      <h2>Audit API</h2>
      <p className="text-muted">POST a public website URL to <code>/api/studio/site-audit/run</code>. The route requires Studio auth, workspace membership, SSRF-safe URL validation, timeout limits, and saved workspace persistence.</p>
