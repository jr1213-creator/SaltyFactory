...
export default async function BusinessExperimentsPage() {
  ...
  return <>
    ...
    <section className="surface-card">
      ...
      <form className="form-grid" action="/api/studio/business/experiments" method="post">
        ...
        <button className="btn btn-primary" type="submit">Save Experiment</button>
      </form>
    </section>
    <section style={{ marginTop: 18 }}>{experiments.length ? <div className="layout-grid">{experiments.map((experiment: any) => <ForecastScenarioCard key={experiment.id} title={experiment.title}>
