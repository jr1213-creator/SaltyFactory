  ...
  return <>
    ...
    <div className="layout-grid layout-grid-2">
      <section className="surface-card">
        ...
        <form className="form-grid" action="/api/studio/business/print-studio/business-card/generate" method="post">
          ...
          <button className="btn btn-primary" type="submit">Generate Business Card</button>
        </form>
