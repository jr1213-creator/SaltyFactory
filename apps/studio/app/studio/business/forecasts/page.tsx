...
export default async function BusinessForecastsPage() {
  ...
  return <>
    ...
    <section className="sf-card">
      ...
      <form className="sf-form-grid" action="/api/studio/business/forecasts" method="post">
        ...
        <button className="sf-button sf-button-primary" type="submit">Save Forecast</button>
      </form>
    </section>
    <section style={{ marginTop: 18 }}>{forecasts.length ? <div className="sf-grid">{forecasts.map((forecast: any) => <ForecastScenarioCard key={forecast.id} title={forecast.forecast_name ?? forecast.forecastName}>
