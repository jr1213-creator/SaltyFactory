...
export default async function BusinessFinancialsPage() {
  ...
  return <>
    ...
    <section className="surface-card">
      ...
      <form className="form-grid" action="/api/studio/business/unit-economics/calculate" method="post">
        ...
        <button className="btn btn-primary" type="submit">Calculate and Save</button>
      </form>
    </section>
    <section style={{ marginTop: 18 }}>
      {unitEconomics.length ? <div className="layout-grid">
