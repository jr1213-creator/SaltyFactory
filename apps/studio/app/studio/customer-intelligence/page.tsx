...
export default async function CustomerIntelligencePage() {
  ...
  return <>
    ...
    <section className="surface-card" style={{ marginTop: 18 }}>
      ...
      <p className="text-muted">Website/customer behavior tracking is not configured yet unless real events are present below.</p>
      <DataTable
    ...
    <section className="surface-card" style={{ marginTop: 18 }}>
      ...
      <p className="text-muted">Use this for owner-entered or imported customer intelligence events. It does not imply live website tracking.</p>
      <form className="layout-grid layout-grid-2" action="/api/studio/crm/intelligence" method="post">
