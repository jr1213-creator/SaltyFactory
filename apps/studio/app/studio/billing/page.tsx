...
export default function Page() {
  return <>
    ...
    <section className="sf-card" style={{ marginTop: 18 }}><h2>Usage</h2><ProgressBar label="AI credits" value={0} /><ProgressBar label="Storage" value={0} /><ProgressBar label="Publish reviews" value={0} /><p className="sf-muted">Usage meters remain empty until billing and metering providers are configured.</p></section>
