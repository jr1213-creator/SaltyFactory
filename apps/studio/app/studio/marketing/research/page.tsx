...
export default async function VoiceOfMarketResearchPage() {
  ...
  return <>
    ...
    <section className="sf-card">
      ...
      <form className="sf-grid sf-grid-2" action="/api/studio/shared/source-records" method="post">
        ...
        <button className="sf-button" type="submit">Save Research</button>
      </form>
    </section>
    <section className="sf-card" style={{ marginTop: 18 }}>
      ...
      <form className="sf-grid sf-grid-2" action="/api/studio/shared/assets" method="post">
        ...
        <button className="sf-button" type="submit">Save Swipe Reference</button>
      </form>
    </section>
    <section className="sf-card" style={{ marginTop: 18 }}>
