...
export default function Page() {
  ...
  return <>
    ...
    <div className="sf-grid sf-grid-2">
      <section className="sf-card"><h2>Workspace Settings</h2><DataTable columns={["Setting", "Value"]} rows={[["Workspace", "Salty Cowhide"], ["Business profile", <a key="biz" href="/studio/settings/business-profile">Open</a>], ["Channels", <a key="channels" href="/studio/channels">Open</a>], ["Migration guide", <a key="migration" href="/studio/migration-guide">Open</a>], ["Live publishing", cfg.LIVE_PUBLISHING_ENABLED ? "Enabled" : "Disabled by default"]]} /></section>
