...
2. Hugging Face generation uses the connected Guided Setup credential server-side, stores generated bytes in private storage, creates a `design_assets` row, and returns a structured result with a protected preview link.
